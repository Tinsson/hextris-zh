...
function initialize(a) {
    ...
    if (/Mobile|Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
        ...
        $("#inst_main_body").html("不同颜色的<span style='color:#f1c40f;'>小</span><span style='color:#e74c3c'>矩</span><span style='color:#3498db'>形</span><span style='color:#2ecc71'>块</span>会落入六边形的区域<br><br> 当三个颜色或三个以上的小条相连时会消除并获得分数<br><br>触碰屏幕的左边和右边会旋转中心<br><br>点击中心六角还能加速哦！！！<br><br> ");
